                ...
                <form class="form-group" action="../../assets/functions/func.php" method="post">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="patient_id" id="p1">
                          <?php display_pat_id($_SESSION['docid']); ?>
                        </select>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="med_id" id="p1">
                          <?php display_meds(); ?>
                        </select>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" name="med_quantity" type="number">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="update ml-auto mr-auto">
                      <button type="submit" class="btn btn-primary btn-round" name="prescribe_btn">Prescribe</button>
                    </div>
                  </div>
                </form>
              </div>
