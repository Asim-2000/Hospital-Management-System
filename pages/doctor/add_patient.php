                ...
                <div class="row">
                  <div class="card-body ">
                    <form class="form-group" action="../../assets/functions/func.php" method="post">
                      ...
                      <input type="hidden" name="docapp" class="form-control" value="<?php echo $_SESSION['docid'] ?>"><br>
                      ...
                      <select class="form-control" name="bdgroup">
                      ...
                      <input type="submit" class="btn btn-primary btn-round" name="doc_pat_register" value="Register">
                    </form>
                  </div>
                </div>
              </div>
