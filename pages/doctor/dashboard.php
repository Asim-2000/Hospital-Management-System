          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title"><?php pat_count(); ?>
                        <p>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-footer ">
                ...
                <div class="stats">
                  <a href="">
                  <i class="fa fa-refresh"></i></a> Update Now
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">Your Patients</p>
                      <p class="card-title"><?php doc_pat_count($_SESSION['docid']); ?>
                        <p>
                    </div>
                  </div>
                </div>
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">Pharmacists</p>
                      <p class="card-title"><?php phar_count(); ?>
                        <p>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title"><?php doc_prescription_count($_SESSION['docid']); ?>
                      <p>
                    </div>
                  </div>
                </div>
