                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title"><?php shipment_count(); ?>
                        <p>
                    </div>
                  </div>
                </div>
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">Medicine</p>
                      <p class="card-title"><?php med_count(); ?>
                        <p>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title"><?php prescription_count(); ?>
                        <p>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title"><?php supplier_count(); ?>
                      <p>
                    </div>
                  </div>
                </div>
