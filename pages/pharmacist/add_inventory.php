                ...
                <div class="row">
                  <div class="card-body ">
                    <form class="form-group" action="../../assets/functions/func.php" method="post">
                      ...
                      <input type="number" name="medicine_quantity" class="form-control"><br>
                      <label>Shipment Date:</label>
                      <input type="datetime-local" name="shipment_date" class="form-control"><br>
                      <input type="submit" class="btn btn-primary btn-round" name="shipment_register" value="Register">
                    </form>
                  </div>
                </div>
              </div>
