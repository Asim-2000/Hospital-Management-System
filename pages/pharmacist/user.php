          ...
          <div class="col-md-4">
            <div class="card card-user">
              ...
              <div class="card-body">
                <div class="author">
                  <a href="#">
                    <img class="avatar border-light" src="../../assets/img/phar_avatar.png" alt="...">
                ...
                <form class="form-group" action="../../assets/functions/func.php" method="post">
                  ...
                  <div class="row">
                    <div class="update ml-auto mr-auto">
                      <button type="submit" class="btn btn-primary btn-round" name="update_phar">Update Profile</button>
                    </div>
                  </div>
                </form>
              </div>
